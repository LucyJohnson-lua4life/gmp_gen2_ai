...
import { getWeaponMasterMaleInstance, INSTANCE_HOLY_ENFORCER} from "./npcInits";
import { ArmorInstances } from "../equipment/armors";
import { HolyEnforcerDescription } from "../descriptions/holyEnforcerDescription";

export class HolyEnforcer implements IAiNpc {
    enemyIds: number[];
    friendIds: number[];
    respawnTime: number;
    ...
    constructor(tags: Array<string>) {
        ...
        this.friendIds = [];
        this.respawnTime = 10;
        this.actionDescriptions = [new HolyEnforcerDescription(this.id)]
        this.aiTags = new Map();
